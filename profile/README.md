...
<img 
  src="https://github.com/lazycatlabs/blog.lazycatlabs.com-giscus/blob/main/lazycatlabs/lazycat_new_banner.png" 
  style="margin-top:50px;margin-right:13px;margin-bottom:20px"
/>
